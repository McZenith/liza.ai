      ...
      >
        ...
        >
          ...
          {[
            ...
            { name: "Airbnb", icon: <Image src="/airbnb.png" alt="Airbnb" width={20} height={20} priority className="w-4 h-4 md:w-5 md:h-5" />, color: "#FF5A5F" },
          ].map((platform, i) => (
            <motion.div
              key={platform.name}
...
export default function Home() {
  return (
    <>
      ...
      <a
        href="#main-content"
        className="absolute -top-full left-4 z-[100] px-4 py-2 bg-[#FF4F00] text-white rounded-lg transition-all focus-visible:top-4 outline-none"
        tabIndex={0}
      >
