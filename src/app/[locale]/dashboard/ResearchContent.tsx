    ...
    return (
        <div className="space-y-8 relative">
            ...
            <button
                ...
                className={`fixed top-20 lg:top-24 right-4 z-40 w-14 h-14 rounded-2xl bg-gradient-to-br from-[#FF4F00] to-[#FF7A33] text-white shadow-lg shadow-orange-500/30 flex items-center justify-center transition-transform ${cartBounce ? "scale-125" : "scale-100"}`}
            >
